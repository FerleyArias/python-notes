...
class Notas:
    ...
    def guardar(self):
        ...
        usuario = (self.usuario_id, self.titulo,
                   self.descripcion, now)
        try:
            cursor.execute(sql, usuario)
            database.commit()
            print("La nota ha sido creado correctamente!")
        except:
            print("Error en creación de la nota, verifique sus datos")
